...
def endAction(grid, score, issue, issueAuthor, issueText, isNewGame):
    ...
    if checkNextActions(grid):
        ...
        # Reply and close the issue
        issue.create_comment(f"{issueAuthor} {issueText}\nThe gameboard may take a few moments to refresh.\n\nAsk a friend to do the next action: [Share on Twitter...](https://twitter.com/intent/tweet?text=I%27m%20playing%202048%20on%20a%20GitHub%20Profile%20Readme!%20I%20just%20played.%20You%20have%20the%20action%20at%20https%3A%2F%2Fgithub.com%2Fleogopal%2Fleogopal)")
    ...
    # Game ended
        ...
        readme[1] = "<a  href=\"https://github.com/leogopal/readme-2048/issues/new?title=2048|newGame&body=Just+push+'Submit+new+issue'.+You+don't+need+to+do+anything+else.\"><img src=\"Assets/newGame.png\"/></a>"
